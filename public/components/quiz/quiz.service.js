        ...
        var allQuestions = [
            {
                ...
                notes : 'That isn\'t the only factor that affects things, but in general, the more examples it has to learn from, the better.'
            },
            {
                ...
                answers : [
                    ...
                    { text : 'Varied photos of apples', correct : true },
                    { text : 'Identical photos of an apple', correct : false },
                    { text : 'Very very similar photos of the same apple', correct : false }
                ],
                notes : 'The more varied the examples you can collect, the more the system can learn about how to recognise different pictures of an apple. If every example you give it is an apple on a brown wooden table, it might learn that something is only an apple if it\'s on a brown wooden table.'
            },
            {
                ...
                answers : [
                    ...
                    { text : 'Recognsing if an email is spam or not', correct : true },
                    { text : 'Counting the number of times a button is pressed', correct : false }
                ],
                notes : 'Spam filters are a good example of machine learning. With enough examples of legitimate emails, and enough examples of spam emails, a computer can start to learn how to recognise a spam email - without someone needing to manually define a set of rules first.'
            },
            {
                ...
                notes : 'Tasks which involve following rules that can be worked out are not a good use for machine learning. A computer isn\'t going to learn how to apply an exchange rate from examples - we can just tell it what to do.'
            },
            {
                ...
                notes : 'More examples is generally better, but be practical. Pragmatism is important, so regular testing is useful to let you know how things are going, and when you\'ve done enough. When you\'ve only got ten examples, another ten will probably make a huge difference. When you\'ve got 100,000 examples, another ten probably won\'t have a noticeable impact.'
            },
            {
            ...
            },
            {
                ...
                notes : 'Machine learning does not mean computers magically learn to do everything. It means they learn how to do a specific task by being shown examples of that specific task. If you want it to do something else, you need to train it to do that as well, by giving it examples of that.'
            },
            {
                ...
                notes : 'Collecting a roughly similar number of examples for each label is a useful technique. If nearly every example of writing you train a system with is happy, you might end up training the system to assume that sad writing is very unlikely, and that it should assume happy more often. But, you might want it to do this. If you\'re training a system to recognise text where it is happy 98% of the time, then training it with that realistic experience might be worth a try.'
            }
        ];
