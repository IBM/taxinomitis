...
CREATE INDEX imagetraining_getimagetraining ON mlforkidsdb.imagetraining USING btree (projectid, label, imageurl);
...
-- ALTER DATABASE mlforkidsdb
--     SET search_path TO mlforkidsdb;
