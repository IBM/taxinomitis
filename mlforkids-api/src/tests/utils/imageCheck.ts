...
describe('Utils - imageCheck', () => {
    ...
    it('should reject images that exceed size limits', async () => {
        await assert.rejects(
            ...
            { message: 'Image file size (23.07 kB) is too big. Please choose images smaller than 8 kB' }
        );
    });
...
const VALID_JPG = 'https://i.allthepics.net/2026/03/08/a96c9713f829.jpeg';
const VALID_PNG = 'https://i.allthepics.net/2026/03/08/74e7650350af.png';
const INVALID_GIF = 'https://i.allthepics.net/2026/03/08/b790f265ec59.gif';
