                ...
                async.each(unzippedFilesInfo,
                    (unzippedFile: any, nextFile) => {
                        ...
                        case 17401:
                            ...
                            break;
                        case 8991:
                            filecompare('./src/tests/utils/resources/ibm-4.png',
                                        unzippedFile.location,
                                        (isEq: boolean) => {
                                            assert(isEq, './src/tests/utils/resources/ibm-4.png');
                                            nextFile();
                                        });
                            break;
                        case 16720:
                            filecompare('./src/tests/utils/resources/ibm-5.png',
                                        unzippedFile.location,
                                        (isEq: boolean) => {
                                            assert(isEq, './src/tests/utils/resources/ibm-5.png');
                                            nextFile();
                                        });
                            break;
                        case 22724:
