...
async function handle(request) {
  ...
  if (url.pathname.startsWith('/scratch3') || url.pathname.startsWith('/scratchx')) {
    ...
    return handleRequest(request, [
        ...
        'mlforkids-login.j8ahcaxwtd1.au-syd.codeengine.appdomain.cloud'
    ]);
...
async function forwardRequest(request, targetHost) {
